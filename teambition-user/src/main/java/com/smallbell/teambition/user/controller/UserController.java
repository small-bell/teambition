package com.smallbell.teambition.user.controller;
...
import com.smallbell.teambition.user.service.UserService;
...
public class UserController {
    ...
    public Result login(@RequestBody User user) {
        User result = userService.login(user.getMobile(), user.getPassword());
        if (result == null) {
