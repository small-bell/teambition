package com.smallbell.teambition.user.service;

import com.smallbell.teambition.common.util.IdWorker;
import com.smallbell.teambition.user.dao.AdminDao;
...
public class AdminService {
	...
	public Admin login(Admin admin) {
		...
		//然后拿数据库中的密码和用户输入的密码是否匹配
		//登陆用户名不等于null 并且密码要和加密密文匹配，只有不为空且密码匹配才能登陆成功
