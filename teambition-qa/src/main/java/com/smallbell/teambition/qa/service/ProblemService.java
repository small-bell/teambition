package com.smallbell.teambition.qa.service;


import com.smallbell.teambition.common.util.IdWorker;
import com.smallbell.teambition.qa.dao.ProblemDao;
...
public class ProblemService {
	 ...
	 * @return
	 */
	public Page<Problem> findNewList(String labelId, Integer page, Integer size){
	 ...
	 * @return
	 */
	public Page<Problem> findHotList(String labelId, Integer page, Integer size){
		Pageable pageable = PageRequest.of(page-1,size);
	 ...
	 * @return
	 */
	public Page<Problem> findWaitList(String labelId, Integer page, Integer size){
		Pageable pageable = PageRequest.of(page-1,size);
